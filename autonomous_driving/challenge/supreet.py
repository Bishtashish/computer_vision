...
class NeuralNetwork(object):
    def __init__(self, Lambda = 0):        
        ...
        #Weights (parameters)
        sd1 = np.sqrt(2/self.inputLayerSize)
        self.W1 = np.random.uniform(-sd1,sd1,(self.inputLayerSize,self.hiddenLayerSize))
        sd2 = np.sqrt(2/self.hiddenLayerSize)
        self.W2 = np.random.uniform(-sd2,sd2,(self.hiddenLayerSize,self.outputLayerSize))
